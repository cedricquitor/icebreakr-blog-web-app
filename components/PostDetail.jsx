...
const PostDetail = ({ post }) => {
  ...
  return (
    <div className="pb-12 mb-8 bg-teal-50 shadow-lg rounded-lg lg:p-8">
      <div className="mb-6 relative overflow-hidden shadow-md">
      ...
      <div className="px-4 lg:px-0">
        <div className="mb-8 w-full flex items-center">
          <div className="mb-4 mr-8 w-full flex items-center lg:mb-0 lg:w-auto">
        ...
        {post.content.raw.children.map((typeObject, index) => {
          const children = typeObject.children.map((item, itemIndex) => getContentFragment(itemIndex, item.text, item));
          return getContentFragment(index, children, typeObject, typeObject.type);
        })}
      </div>
    </div>
  );
